...
//------------------------------------------------------------------------------------------------//
    ...
    public function actionIndex() {
         ...
         * 
         */
        $news_type1 = News::find()->where(['status' => '1','newtype' => '1'])->all();
        $news_type2 = News::find()->where(['status' => '1','newtype' => '2'])->all();
        return $this->render('index',[
            'news_type1' => $news_type1,
    ...
    public function actionVission() {
        return $this->render('vission');
    }
    ...
    public function actionStrategicplan() {
        return $this->render('strategicplan');
    }
    
    public function actionRaws() {
        return $this->render('raws');
    }
